    ...
    <div class="register">
        <div class="panel panel-danger" style="width:400px;">
            <div class="panel-heading" >
                <h3 class="panel-title" ><font style="font-family:Tahoma, Geneva, sans-serif">增加航班</font></h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" method="post" action="/plane/admin/addPlaneTicket.do" enctype="application/x-www-form-urlencoded" role="form" id="myForm" onsubmit="return validateRegister()" >
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="planeStartTimeString" name="planeStartTimeString" class="form-control" placeholder="请输入起飞时间" aria-describedby="basic-addon1" onfocus="WdatePicker({alwaysUseStartDate:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})"  class="text20 gray date medium" size="22" >
                    </div>
                    <p></p>
                    <div class="input-group">
