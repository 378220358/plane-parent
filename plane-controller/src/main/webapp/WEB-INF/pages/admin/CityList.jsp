  ...
  <div class="register">
    <div class="panel panel-danger" style="width:400px;">
      ...
      <table cellspacing="0" summary="" class="tab" id="pollTab">
        <thead>
        <th style="text-align:center;" width="50px">城市ID</th>
        <th style="text-align: center;" width="100px">城市名称</th>
        <th style="text-align:center;" width="100px">城市编号</th>
        ...
        <c:forEach items="${cityList}" var="city">
          <tr>
            <td style="text-align:center;"><c:out value='${city.cityId}'/></td>
            <td style="text-align:center;"><c:out value='${city.cityName}'/></td>
            <td style="text-align:center;"><c:out value='${city.cityCode}'/></td>
            <td style="text-align:center;"><a href="/plane/admin/updateCityIndex.do?cityId=${city.cityId}">修改</a> </td>
            <td style="text-align:center;"><a href="/plane/admin/deleteCity.do?cityId=${city.cityId}">删除</a> </td>
          </tr>
        </c:forEach>
        </tbody>
      </table>
