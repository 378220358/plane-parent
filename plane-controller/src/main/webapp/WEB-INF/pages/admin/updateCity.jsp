  ...
  <div class="register">
    <div class="panel panel-danger" style="width:400px;">
      <div class="panel-heading" >
        <h3 class="panel-title" ><font style="font-family:Tahoma, Geneva, sans-serif">修改开通城市</font></h3>
      </div>
      <div class="panel-body">
        <form action="/plane/admin/updateCity.do" onsubmit="return validateRegister()" method="post">
        <div class="input-group">
          <input type="hidden" name="cityId" value="${city.cityId}">
          <span class="input-group-addon">开通城市：</span>
          <input type="text" name="cityName"  id="cityName" class="form-control" placeholder="请输入城市名称" aria-describedby="basic-addon1" value="${city.cityName}">
        </div>
          <p></p>
          <div class="input-group">
            <span class="input-group-addon">城市编码：</span>
            <input type="text" name="cityCode" id="cityCode" class="form-control" placeholder="请输入城市编码" aria-describedby="basic-addon1" value="${city.cityCode}">
          </div>
        <p></p>
        <div>
          &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
          <button type="submit" class="btn btn-primary" id="registerSubmit">修改</button>
