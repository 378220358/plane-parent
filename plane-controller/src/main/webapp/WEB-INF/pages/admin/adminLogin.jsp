...
<div style="width:670px; height:550px; position:absolute; top:30%; left:55%;">
  <div class="panel panel-danger" style="width:400px;">
    <div class="panel-heading" >
      <h3 class="panel-title" ><font style="font-family:Tahoma, Geneva, sans-serif">管理员登录界面</font></h3>
    </div>
    <div class="panel-body">
      <form class="form-horizontal" method="post" action="/plane/admin/login.do" enctype="application/x-www-form-urlencoded" role="form" id="myForm">
        <table>
          <tr>
