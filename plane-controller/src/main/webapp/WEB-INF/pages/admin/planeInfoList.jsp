    ...
    <div class="ticket">
        <div class="panel panel-danger" style="width:900px;">
            <div class="panel-heading" >
                <h3 class="panel-title" ><font style="font-family:Tahoma, Geneva, sans-serif">航班售卖列表</font></h3>
            </div>
            <table cellspacing="0" summary="" class="tab" id="pollTab">
                ...
                <th style="text-align:center;" width="100px">已经卖出票数</th>
                <th style="text-align:center;" width="100px">剩余票数</th>
                </thead>
                <tbody>
                <c:forEach items="${planeList}" var="plane">
                    <tr>
                        ...
                        <td style="text-align:center;"><c:out value='${plane.alerdySale}'/></td>
                        <td style="text-align:center;"><c:out value='${plane.remainSale}'/></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
