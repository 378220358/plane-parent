 ...
 * Copyright (c) Department of Research and Development/asiainfo-linkage.
 * All Rights Reserved.
 * @version 1.0  2011-9-26 下午04:08:13  by 凡红恩（fanhe@asiainfo-linkage.com）创建
 */
public class ResponseUtils {
	...
	public static void printMapToJson2(HttpServletResponse response, Map<String, Object> map) {
		try {
			print(response, "application/json;charset=UTF-8", "[" + JSONObject.fromObject(map).toString()
					+ "]");
		} catch (Exception ex) {
			log.error(ex.toString());
		}
